 ...
 */
 ...
 function ntshka_admin_styles() {
       

        wp_enqueue_style( 'ntshka-admin-style', NTSHKA_PLUGIN_URL . 'assets/source/css/ntshkaadmin.css', [], rand(), 'all' );

    }
add_action('admin_enqueue_scripts','ntshka_admin_styles');
final class ntshka_addons {
    ...
    */
    public function scripts_styles() {
        ...
        wp_register_style( 'ntshka-admin-style', NTSHKA_PLUGIN_URL . 'assets/source/css/ntshkaadmin.css', [], rand(), 'all' );
...
*
*/
function ntshka_addons_MENU(){
    add_menu_page("Ntshka Addons", "Ntshka Addons",9,"ntshka-addons","ntshka_addons_page","
    dashicons-cloud");
    
    require NTSHKA_PLUGIN_PATH . 'admin/ntshka-settings-page.php';
}
add_action("admin_menu", "ntshka_addons_MENU");
...
*
*/
function ntshka_add_settings_link( $links ) {
    $settings_link = '<a href="admin.php?page=ntshka-addons">' . __( 'Settings' ) . '</a>';
    array_push( $links, $settings_link );
    return $links;
}
$filter_name = "plugin_action_links_" . plugin_basename( __FILE__ );
add_filter( $filter_name, 'ntshka_add_settings_link' );

// Dashboard Widget
function ntshka_admin_dashboard_widget(){
...
add_action('wp_dashboard_setup','ntshka_admin_dashboard_widget');
function admin_dashboard_widget_callback(){
echo 'Please Consider  <a href="https://www.paypal.com/paypalme/nikushasirbiladze">Donation</a> for more good content, Also Please <a href="https://wordpress.org/plugins/ntashka-addons/">Review Us on wordpress.org!</a>';
}
